...
class MyStatusAdapter (): RecyclerView.Adapter<MyStatusAdapter.MainViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MainViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.row_my_status, parent, false)
